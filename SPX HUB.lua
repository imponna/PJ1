...
local Farm1 = serv:Channel("AutoFarm")

-------------------------------------------------

Farm1:Toggle("Auto-Farm",false,_G.Auto_Farm_Level, function(value)
...
local SelectWeapona = Farm1:Dropdown("SelectWeapon!",WeaponList, function(value)
_G.Select_Weapon = value
end)

Farm1:Button("Refresh Weapon", function()
SelectWeapona:Clear()
 for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
...
Farm1:Button("StopTween", function()
    topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
  _G.Clip = false
end)
...
-------------------------------------------------
local Setting1 = serv:Channel("Setting")
-------------------------------------------------

Setting1:Label("Youtube Chanel!")


Setting1:Button("Copy Youtube Link",function()
 
 setclipboard("https://youtube.com/@LocalPlayer5757")
end)
...
Setting1:Toggle("รวมมอน [Normal]",true,function(value)
...
Setting1:Toggle("รวมมอน [Extra+Lag]",false,function(value)
 _G.BringExtra = value
end)
 ...
 game:GetService("RunService").Heartbeat:Connect(function() CheckQuest()
  pcall(function()
   ...
   sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
		...
		Setting1:Toggle("ตีเร็ว [New]",true,function(value)
 _G.FastAttack = value
end)
...
Setting1:Toggle("ออโต้เปิดฮาคิสังเกต",_G.Auto_Ken,function(vu)
	_G.Auto_Ken = vu
end)
spawn(function()
	while wait(2) do
...
Setting1:Toggle("ออโต้คลิก",false,function(value)
 _G.click = value
end)
...
Setting1:Toggle("ปิดเลขดาเมจ",_G.DisableDamage,function(value)
...
Setting1:Toggle("จอขาว [ Booster FPS ]",_G.WhiteScreen,function(value)
...
Setting1:Button("ภาพกาก",function()
        pcall(function()
...
Setting1:Seperator(" ตั้งค่า ฟามมาส ")
...
Farm1:Seperator(" Server ")

Time = Farm1:Label("Executer Time")
