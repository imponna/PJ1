...
Setting:Dropdown("เลือกตำแหน่งฟาม", {"Behind","Below","Upper",function(value)
 _G.Method = value
end)
...
Main:Dropdown("SelectMonster", tableMon, function(vu)
 SelectMonster = vu
 end)
...
Teleport:Seperator(" World ")
 ...
 if World1 then
 Teleport:Dropdown("SelectIsland", {
  "WindMill",
  "Marine",
  "Middle Town",
  "Jungle",
...
Dungeon:Dropdown("เลือกชิบ",chip,function(value)
...
DevilFruit:Seperator(" ซื้อผลระยะไกล ")
 ...
 _G.SelectFruit = ""
 DevilFruit:Dropdown("เลือกผล",FruitList,function(value)
 ...
 DevilFruit:Dropdown("เลือกผลกิน",FruitList,function(value)
...
local x2Code = {
 ...
 "Enyu_is_Pro"
    ...
    Misc:Dropdown("เลือกโค้ด",{"1MLIKES_RESET","THIRDSEA","SUB2GAMERROBOT_RESET1","SUB2UNCLEKIZARU"},function(value)
        _G.CodeSelect = value
    end)
